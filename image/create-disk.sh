...
label: gpt
unit: MiB
start=1, size=${EFI_SIZE_MB}, type=C12A7328-F81F-11D2-BA4B-00A0C93EC93B, name="ESP"
start=$((EFI_SIZE_MB + 1)), size=${ROOT_SIZE_MB}, type=0FC63DAF-8483-4772-8E79-3D69D8477DE4, name="archlinux"
EOF
